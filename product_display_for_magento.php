...
function magepd_add_admin_menu()
{
   ...
   add_options_page('Product Display for Magento', 'Product Display for Magento', 'manage_options', 'mage_product_display_', 'magepd_options_page');
